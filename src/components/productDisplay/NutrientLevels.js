...
const NutrientLevels = (product) => (
  <section className="productDisplay__section">
    <h3 className="productDisplay__sectionTitle">Уровни питательных веществ</h3>
    {product.product.nutrientLevels() !== undefined ?
      ...
      :
      <div className="produtList__unknown">Неизвестно <span role="img" aria-label="question emoji">❓</span></div>
    }
  </section>
);
